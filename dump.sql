...
CREATE TABLE `game` (
  ...
  KEY `fk_game_status_idx` (`game_status`),
  CONSTRAINT `fk_game_status` FOREIGN KEY (`game_status`) REFERENCES `game_status` (`game_status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `game_status` VALUES (0,'pending'),(1,'in_play'),(2,'completed');
...
CREATE TABLE `move` (
  ...
  `half_move_clock` int(11) NOT NULL,
...
CREATE TABLE `participant` (
  ...
  `color` int(1) DEFAULT NULL COMMENT '0 or 1 as usual. Null if we want it to set auto',
...
INSERT INTO `user` VALUES (37,'becky'),(43,'becky1'),(44,'becky2'),(59,'becky3'),(13,'doggy'),(22,'don'),(21,'doobie');
...
-- Dump completed on 2017-03-11 10:11:42
